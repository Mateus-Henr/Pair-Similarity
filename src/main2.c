/*
    * main2.c
    *
    * Using  Knuth-Morris-Pratt algorithm to find the number of pattern matching.
*/
...
int main()
{
    printf("Welcome to the similarity calculator, using Knuth-Morris-Pratt algorithm!\n\n");
